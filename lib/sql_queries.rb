...
"SELECT projects.title, projects.funding_goal - (SUM)pledges.amount FROM projects INNER JOIN pledges ON projects.id = pledges.project_id HAVING funding_goal < SUM(pledges.amount)"
end
